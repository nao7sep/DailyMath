...
public class WpfTextMeasurerTests
{
    ...
    [Fact]
    public void MeasureText_HigherDpi_MayProduceDifferentResults()
    {
        var font = new FontSpec("Arial", 12);
        var text = "Hello";
        ...
        // WPF's FormattedText with pixelsPerDip should scale, but behavior may vary
        // Just verify both produce valid measurements
        Assert.True(lowDpiMeasure.Width.Value > 0);
        Assert.True(highDpiMeasure.Width.Value > 0);
    }
    ...
    [Fact]
    public void MeasureText_UnderlineStyle_DoesNotThrow()
    {
        var font = new FontSpec("Arial", 12, FontWeight.Normal, FontStyle.Underline);
        var measure = _measurer.MeasureText("Hello", font, StandardDpi);
    ...
    [Fact]
    public void MeasureText_StrikethroughStyle_DoesNotThrow()
    {
        var font = new FontSpec("Arial", 12, FontWeight.Normal, FontStyle.Strikethrough);
        var measure = _measurer.MeasureText("Hello", font, StandardDpi);
    ...
    [Fact]
    public void MeasureText_VariousWeights_DoesNotThrow()
    {
        var text = "Hello";
    ...
    [Fact]
    public void GetMaxFontSize_DifferentDpi_ProducesValidResults()
    {
        var baseFont = new FontSpec("Arial", 12);
        var text = "Hello";
        var bounds = new Measure(200.AsPixels(), 50.AsPixels());
        ...
        // Both should produce valid sizes within range
        Assert.True(size96 >= 6 && size96 <= 72);
        Assert.True(size300 >= 6 && size300 <= 72);
    }
    ...
    public void GetMaxFontSize_WithUnderlineStyle_ProducesValidSize()
    {
        ...
        // Verify the result is valid and text fits
        var testFont = baseFont.WithSize(maxSize);
        var measure = _measurer.MeasureText(text, testFont, StandardDpi);
    ...
    [Fact]
    public void GetMaxFontSize_WithCombinedStyles_ProducesValidSize()
    {
        var baseFont = new FontSpec("Arial", 12, FontWeight.Bold, FontStyle.Italic | FontStyle.Underline | FontStyle.Strikethrough);
        var text = "Hello";
        var bounds = new Measure(200.AsPixels(), 50.AsPixels());
    ...
    [Fact]
    public void MeasureText_ConsistentAtBaseline96Dpi_WorksCorrectly()
    {
        // Verify that measurement works correctly at WPF's baseline DPI
        var font = new FontSpec("Arial", 12);
        var text = "Hello";

        var measure96 = _measurer.MeasureText(text, font, 96);
